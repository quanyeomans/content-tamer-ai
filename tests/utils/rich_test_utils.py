...
# Import Rich components that we'll need for testing
try:
...
class RichTestCase:
    """
    Base test case mixin with Rich testing utilities.
    
    Provides standardized Rich testing patterns and utilities.
    Use by inheriting alongside unittest.TestCase:
    ...
    def assert_no_rich_errors(self):
    ...
    def assert_no_rich_errors(self) -> None:
