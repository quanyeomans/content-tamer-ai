...
class TestDisplayManager:
    ...
    def __init__(self, options: Optional[DisplayOptions] = None):
        ...
        self.options = options or DisplayOptions(quiet=True, no_color=True)
        ...
        self.stats = type('Stats', (), {
            ...
            'total': 0,
            'success_rate': 0.0,
            'succeeded': 0,  # Alternative naming
            'errors': 0      # Alternative naming
        })()
        ...
        self.progress = type('Progress', (), {'stats': self.stats})()
    ...
    def show_startup_info(self, info_dict=None, **kwargs):
        """Show startup information."""
        if not self.quiet:
            self.output_lines.append("STARTUP: Content Tamer AI starting")
    
    def show_completion_summary(self, stats=None, **kwargs):
    ...
    def show_completion_stats(self, stats=None, **kwargs):
        """Show completion statistics."""
        if not self.quiet and stats:
            self.output_lines.append(f"STATS: Completion stats displayed")
