...
from utils.progress_display import ProgressDisplay, ProgressStats
...
class TestProgressDisplay(unittest.TestCase):
    ...
    def test_update_progress(self):
        ...
        self.progress.update(filename="test1.pdf", status="processing")

        self.assertEqual(self.progress.current_filename, "test1.pdf")
    ...
    def test_update_without_increment(self):
        ...
        self.progress.update(filename="test.pdf", increment=False)

        self.assertEqual(self.progress.stats.completed, initial_completed)
        self.assertEqual(self.progress.current_filename, "test.pdf")
    ...
    def test_finish_with_stats(self):
        ...
        self.progress.update(filename="test1.pdf")
        self.progress.add_warning()
        self.progress.update(filename="test2.pdf")
        self.progress.add_error()
    ...
    def test_long_filename_truncation(self):
        ...
        very_long_name = "very_long_filename_" * 10 + ".pdf"
...
class TestProgressDisplayWithColors(unittest.TestCase):
    ...
    def test_progress_bar_with_colors(self):
        ...
        self.progress.update(filename="test.pdf", status="processing")
...
class TestProgressDisplayEdgeCases(unittest.TestCase):
    ...
    def test_update_before_start(self):
        ...
        # Should not crash
        self.progress.update(filename="test.pdf")
