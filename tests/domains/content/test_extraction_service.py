...
class TestExtractionService(unittest.TestCase):
    ...
    def test_get_supported_file_types(self):
        ...
        self.assertIn('.pd', supported_types)
    ...
    def test_find_processor_for_pdf(self):
        ...
        processor = self.service._find_processor_for_file("test.pd")
    ...
    def test_batch_extract_mixed_files(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            pdf_file = os.path.join(temp_dir, "test.pd")
            ...
            with patch.object(self.service, '_find_processor_for_file') as mock_find:
                ...
                self.assertEqual(results[pdf_file].quality, ContentQuality.GOOD)
...
class TestPDFContentProcessor(unittest.TestCase):
    ...
    def test_can_process_pdf(self):
        ...
        self.assertTrue(self.processor.can_process("test.pd"))
    ...
    def test_get_supported_extensions(self):
        ...
        self.assertEqual(extensions, [".pd"])

    def test_dependency_checking(self):
        """Test dependency availability checking."""
        # Dependencies should be checked during initialization
        self.assertHasAttr(self.processor, 'have_pymupd')
        self.assertHasAttr(self.processor, 'have_tesseract')
    ...
    def test_method_availability(self):
        ...
        self.assertEqual(ocr_available, self.processor.have_tesseract and self.processor.have_pymupdf)
    ...
    def test_security_validation_file_too_large(self, mock_getsize, mock_isfile):
        ...
        valid = self.processor._validate_file_security("test.pd")
...
class TestImageContentProcessor(unittest.TestCase):
    ...
    def test_can_process_images(self):
        ...
        self.assertFalse(self.processor.can_process("test.pd"))
        self.assertFalse(self.processor.can_process("test.txt"))
    ...
    def test_get_supported_extensions(self):
        ...
        expected_extensions = ['.png', '.jpg', '.jpeg', '.tif', '.ti', '.bmp', '.gi']
...
class TestExtractedContent(unittest.TestCase):
    ...
    def test_field_assignment(self):
        ...
        self.assertEqual(content.extraction_method, "pymupd")
        self.assertEqual(content.file_type, "pd")
