...
from content_processors import (
    ContentProcessorFactory, PDFProcessor, ImageProcessor
)
...
class TestImageProcessor(unittest.TestCase):
    ...
    def test_extract_content_success(self):
        ...
        try:
            ...
            with patch('content_processors.HAVE_TESSERACT', True), \
                 patch('content_processors.pytesseract.image_to_string') as mock_ocr:
