...
from utils.message_handler import (
    MessageHandler, MessageConfig, MessageLevel, MessagePriority, 
    DisclosureMode, DisplayLocation
)
...
class TestAdvancedMessageFiltering(unittest.TestCase):
    ...
    def test_combined_filtering(self):
        ...
        filtered = self.handler.get_filtered_messages(
            level_filter=MessageLevel.ERROR,
            context_filter="test"
        )
