...
class TestApplicationKernel(unittest.TestCase):
    ...
    def test_discover_documents(self, mock_walk):
        ...
        mock_walk.return_value = [
            ('/test/input', [], ['test.pd', 'image.png', 'unsupported.txt', 'doc.jpg'])
        ]
        ...
        self.assertNotIn('/test/input/unsupported.txt', documents)
    ...
    def test_validate_processing_config_valid(self):
        ...
        with tempfile.TemporaryDirectory() as input_dir, \
            ...
            with patch.object(self.kernel, 'ai_service') as mock_ai_service:
    ...
    def test_get_ai_providers_with_service(self):
        ...
        with patch.object(self.kernel, 'ai_service', mock_ai_service):
    ...
    def test_get_ai_providers_fallback(self):
        ...
        with patch.object(self.kernel, 'ai_service', None):
            providers = self.kernel.get_ai_providers()
    ...
    def test_get_provider_models_with_service(self):
        ...
        mock_ai_service = Mock()
        mock_ai_service.provider_service.get_supported_models.return_value = ["gpt-4o", "gpt-4o-mini"]
    ...
    def test_validate_provider_api_key_with_service(self):
        ...
        with patch.object(self.kernel, 'ai_service', mock_ai_service):
            ...
            mock_ai_service.provider_service.validate_api_key.assert_called_once_with("openai", "test-key")
