...
@dataclass
class MessageConfig:  # pylint: disable=too-many-instance-attributes
...
class MessageHandler:  # pylint: disable=too-many-instance-attributes
    ...
    def success(
        ...
        message: str,
        location: DisplayLocation = DisplayLocation.BELOW_PROGRESS,
        brief: bool = True,  # pylint: disable=unused-argument
        priority: MessagePriority = MessagePriority.NORMAL,
        context: Optional[str] = None,
    ) -> None:
    ...
    def export_message_log(self, include_suppressed: bool = False) -> Dict[str, Any]:
...
class SimpleMessageHandler:
    ...
    def __init__(self, file: Optional[TextIO] = None, **kwargs):  # pylint: disable=unused-argument
        self.file = file or sys.stdout
    ...
    def debug(self, message: str, **kwargs) -> None:  # pylint: disable=unused-argument
        pass  # Debug messages not shown in simple mode

    def info(self, message: str, **kwargs) -> None:  # pylint: disable=unused-argument
        self.file.write(f"[INFO] {message}\n")
        self.file.flush()

    def success(self, message: str, **kwargs) -> None:  # pylint: disable=unused-argument
        self.file.write(f"[SUCCESS] {message}\n")
        self.file.flush()

    def warning(self, message: str, **kwargs) -> None:  # pylint: disable=unused-argument
        self.file.write(f"[WARNING] {message}\n")
        self.file.flush()

    def error(self, message: str, **kwargs) -> None:  # pylint: disable=unused-argument
        self.file.write(f"[ERROR] {message}\n")
        self.file.flush()

    def critical(self, message: str, **kwargs) -> None:  # pylint: disable=unused-argument
