...
from .cli_display import ColorFormatter, Colors
...
class ProgressDisplay:  # pylint: disable=too-many-instance-attributes
    ...
    def complete_file_display(
        ...
        progress_line = f"[{progress_bar}] {percentage:5.1f}% {arrow} {self.formatter.highlight_filename(display_name)} {status_display}"
