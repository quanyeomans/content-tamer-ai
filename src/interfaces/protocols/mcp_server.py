...
from ..base_interfaces import ProtocolInterface, ProcessingResult
        ...
        try:
            ...
            return {
                "content": [
                    {
                        "type": "text",
                        "text": self._format_processing_result(result)
                    }
                ]
            }
    ...
    async def _call_get_provider_info(self, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "error": {
                    "code": -32000,
                    "message": f"Provider info failed: {e}"
                }
            }
