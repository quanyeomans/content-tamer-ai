...
class MockApplicationKernel:
    ...
    def execute_processing(self, config) -> ProcessingResult:  # pylint: disable=unused-argument
    ...
    def get_progress_status(self) -> Dict[str, Any]:
        ...
        return {"status": "mock", "current_task": "none", "progress": 0, "total": 0}

    def get_ai_providers(self) -> List[str]:
        """Get mock AI providers list."""
        return ["openai", "claude", "gemini", "deepseek", "local"]

    def get_provider_models(self, provider: str) -> List[str]:  # pylint: disable=unused-argument
