...
class OrganizationFeatureFlags:
    ...
    def should_auto_enable(self, file_count: int = 1) -> bool:
        ...
        return (
            self.enable_auto_enablement and
            self.is_organization_available(file_count) and
            file_count > 1
        )
...
class FeatureFlagManager:
    ...
    def should_show_guided_navigation(self, file_count: int = 1) -> bool:
        ...
        org_flags = self.get_organization_flags()
        return (
            org_flags.enable_guided_navigation and
            org_flags.should_auto_enable(file_count)
        )
